...
These examples demonstrate that the same workflow can cover different assignment kinds.
They are references to public repositories, not runtime dependencies.
